...
class Ui_MarkWindow(object):
    def setupUi(self, MarkWindow):
        ...
        MarkWindow.resize(265, 95)
        self.mark_menu = QtWidgets.QComboBox(MarkWindow)
        self.mark_menu.setGeometry(QtCore.QRect(20, 20, 221, 31))
        ...
        self.con_bttn.setGeometry(QtCore.QRect(90, 60, 75, 23))
        ...
        self.can_bttn.setGeometry(QtCore.QRect(170, 60, 75, 23))
    ...
    def retranslateUi(self, MarkWindow):
        ...
        self.can_bttn.setText(_translate("MarkWindow", "Cancel"))
