...
class DataRange(QtWidgets.QSlider):
    min_change = QtCore.pyqtSignal(str)
    max_change = QtCore.pyqtSignal(str)


    def __init__(self, *args):
        super(DataRange, self).__init__(*args)
    ...
    def mouseMoveEvent(self, event):
        ...
        self.min_change.emit(str(self._low))
        self.max_change.emit(str(self._high))
